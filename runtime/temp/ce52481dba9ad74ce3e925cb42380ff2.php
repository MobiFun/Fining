<?php /*a:2:{s:42:"D:\www\site1\wstmart\admin\view\index.html";i:1593484702;s:41:"D:\www\site1\wstmart\admin\view\base.html";i:1586703143;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <li class="treeview j-menulevel0 j-sysmenu<?php echo $left0['menuId']; ?>" <?php if($key0>1): ?>style='display:none'<?php endif; ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li>
             ...
             <a id="menuItem<?php echo $left2['menuId']; ?>" class='menuItem' href="<?php echo $left2['privilegeUrl']; ?>" dataid='<?php echo $left2['menuId']; ?>'>
             <?php  }else{  ?>
             <a id="menuItem<?php echo $left2['menuId']; ?>" class='menuItem' <?php if((stripos($left2['privilegeUrl'],'admin')!==false || stripos($left2['privilegeUrl'],'addon')!==false)): ?> href="<?php echo Url($left2['privilegeUrl']); ?>"<?php endif; ?> 
             dataid='<?php echo $left2['menuId']; ?>'>
             <?php  }  ?>
              <i class="fa fa-<?php echo !empty($left2['menuIcon']) ? $left2['menuIcon'] : 'circle-o'; ?>"></i><?php echo $left2['menuName']; if(!empty($left2['child'])): ?><i class="fa fa-angle-left pull-right"></i><?php endif; ?></a>
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  <?php  if(stripos($left3['privilegeUrl'],'http://')!==false || stripos($left3['privilegeUrl'],'https://')!==false ){  ?>
                  <a id="menuItem<?php echo $left2['menuId']; ?>" class="menuItem" href="<?php echo $left3['privilegeUrl']; ?>" dataid='<?php echo $left2['menuId']; ?>'><i class="fa fa-<?php echo !empty($left3['menuIcon']) ? $left3['menuIcon'] : 'circle-o'; ?>">
                  <?php  }else{  ?>
                  <a id="menuItem<?php echo $left2['menuId']; ?>" class="menuItem" href="<?php echo Url($left3['privilegeUrl']); ?>" dataid='<?php echo $left2['menuId']; ?>'><i class="fa fa-<?php echo !empty($left3['menuIcon']) ? $left3['menuIcon'] : 'circle-o'; ?>">
                  <?php  }  ?>
                  </i><?php echo $left3['menuName']; ?>
                  </a>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
