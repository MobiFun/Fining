							...
							<li>
								<a target='_blank' href="<?php echo addon_url('groupon://goods/detail','id='.$gn['grouponId']); ?>">
									...
									<div class='time-in' <?php if($gn['status']=='0'): ?>style='display:none'<?php endif; ?>>
							            ...
							            <div class=' groupon-saleTxt'>已團<?php echo $rate; ?>%</div>
							        </div>
