<?php /*a:2:{s:50:"D:\www\site1\wstmart\shop\view\default\\index.html";i:1614052437;s:48:"D:\www\site1\wstmart\shop\view\default\base.html";i:1614052429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wrapper">
  <header class="main-header">
    <a href="<?php echo url('shop/index/index'); ?>" class="logo">
        ...
        <ul class="nav navbar-nav">
           <li id='toMsg'>
            ...
            <div class='j-dorpdown-layer'>
                ...
                <div id='m-msg'><a href='javascript:void(0)' onclick='WST.redirect(120)'>用户消息<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/orders/waitdelivery')): ?>
                <div id='m-24'><a href='javascript:void(0)' onclick='WST.redirect(24)'>待发货订单<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/orders/waituserPay')): ?>
                <div id='m-55'><a href='javascript:void(0)' onclick='WST.redirect(55)'>待付款订单<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/orders/failure')): ?>
                <div id='m-45'><a href='javascript:void(0)' onclick='WST.redirect(45)'>待退款订单<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/ordercomplains/shopComplain')): ?>
                <div id='m-25'><a href='javascript:void(0)' onclick='WST.redirect(25)'>投诉订单<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/orderservices/index')): ?>
                <div id='m-306'><a href='javascript:void(0)' onclick='WST.redirect(306)'>售后信息<span>0</span></a></div>
                <?php endif; if(WSTShopGrant('shop/goods/stockWarnByPage')): ?>
                <div id='m-54'><a href='javascript:void(0)' onclick='WST.redirect(54)'>库存预警<span>0</span></a></div>
                <?php endif; ?>
            </div>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview j-menulevel0 j-sysmenu<?php echo $left0['menuId']; ?>"  <?php if($key0>1): ?>style='display:none'<?php endif; ?>>
             ...
             <ul class="treeview-menu">
                <?php if(is_array($left1['list']) || $left1['list'] instanceof \think\Collection || $left1['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $left1['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$left2): $mod = ($i % 2 );++$i; if(stripos($left2['menuUrl'],'http://')!==false || stripos($left2['menuUrl'],'https://')!==false ){  ?>
                <li><a id="menuItem<?php echo $left2['menuId']; ?>" class='menuItem' href="<?php echo $left2['menuUrl']; ?>" dataid='<?php echo $left2['menuId']; ?>'>
                 <?php  }else{  ?>
                <li><a id="menuItem<?php echo $left2['menuId']; ?>" class='menuItem' href="<?php echo Url($left2['menuUrl']); ?>" dataid='<?php echo $left2['menuId']; ?>'>
                 <?php  }  ?>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <ol class="breadcrumb">
        <li><a href='#' onclick='javascript:location.reload()'><i class='fa fa-map-marker'></i>商家中心</a></li>
      </ol>
...
<audio id='orderTipVoice' controls style='display:none' src="/static/images/order.mp3"></audio>
