<?php /*a:2:{s:46:"D:\www\site1\wstmart\admin\view\shops\add.html";i:1599788713;s:41:"D:\www\site1\wstmart\admin\view\base.html";i:1586703143;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<input type='hidden' id='shopId' name='shopId' class='a-ipt' value="0"/>
...
<legend>公司信息</legend>
                <table class='wst-form wst-box-top'>
                    ...
                    <tr id='newUserTr0' style='display:none'>
                       ...
                       <input type='hidden' class='a-ipt' id='shopUserId' value='0'/>
                       </td>
                    </tr>
                    <tr class='newUserTr1'>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id='shopSn' name='shopSn' class='a-ipt' maxLength='20' data-rule="店铺编号:ignoreBlank;length[1~20];remote(post:<?php echo url('admin/shops/checkShopSn'); ?>)" data-target="#msg_shopSn"/><span class='msg-box' id='msg_shopSn'>(为空则自动生成'S000000001'类型号码)</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height='23'>
                            <?php 
                             ...
                             ?>
                            <label class='accreds'>
                                <input type='checkbox' class='a-ipt' name='accredIds' value='<?php echo $accred["accredId"]; ?>'/><?php echo $accred["accredName"]; ?>
                            </label>
                            <?php } ?>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="<?php echo $vo['fieldName']; ?>" class='a-ipt'>
                                            <?php if($vo['fieldAttr']!='custom'): if(is_array($fieldAttr) || $fieldAttr instanceof \think\Collection || $fieldAttr instanceof \think\Paginator): $i = 0; $__LIST__ = $fieldAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;$fieldAttrValue = explode('||',$voo); ?>
                                                <option value="<?php echo $fieldAttrValue[0]; ?>" ><?php echo $fieldAttrValue[1]; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; else: if($vo['fieldName']=='tradeId'): $_result=WSTTrades(0);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$td): $mod = ($i % 2 );++$i;?>
...
<table class='wst-form wst-box-top'>
  ...
  <tr>
       <td colspan='2' align='center'>
         ...
         <button type="button"  class='btn' onclick="javascript:location.href='<?php echo Url('admin/shops/index','p='.$p); ?>'"><i class="fa fa-angle-double-left" ></i>返回</button>
       </td>
  </tr>
</table>
</fieldset>
