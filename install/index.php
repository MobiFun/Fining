...
<div style="width:1040px;margin:100px auto 0;height:660px;position: relative">
    ...
    <div style="width:900px;margin:0 auto;float: right;background-color: #fff;">
        <div style="margin:0 auto;margin-top:20px;background:url('./images/logo.png') no-repeat left top;width:250px;height:84px;background-size:80%"></div>
        ...
        <div id="system_agreement" class="main">
            <div class='content'>
                ...
                <p>版权所有(c)2016-2021,广州商淘信息科技有限公司</p>
                ...
                <p style='text-indent: 2em'>商淘云官网：<a target='_blank' href='https://www.shangtao.net'>https://www.shangtao.net</a></p>
