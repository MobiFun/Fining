...
CREATE TABLE `wst_suppliers` (
  ...
  `supplierSn` varchar(20) DEFAULT '',
  `userId` int(11) NOT NULL,
  `areaIdPath` varchar(255) DEFAULT '',
  `areaId` int(11) DEFAULT '0',
  `supplierName` varchar(100) DEFAULT '',
  `supplierkeeper` varchar(50) DEFAULT '',
  `telephone` varchar(20) DEFAULT '',
  `supplierCompany` varchar(255) DEFAULT '',
  `supplierImg` varchar(150) DEFAULT '',
  `supplierTel` varchar(40) DEFAULT '',
  `supplierQQ` varchar(50) DEFAULT NULL,
  `supplierWangWang` varchar(50) DEFAULT NULL,
  `supplierAddress` varchar(255) DEFAULT '',
