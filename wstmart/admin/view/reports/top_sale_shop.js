...
function initSaleGrid(){
    ...
    var cols = [
            ...
            {title:'总销售额', name:'totalMoney', width: 130, renderer:function(val,item,rowIndex){return '￥'+val;}},
            {title:'在线支付金额', name:'onLinePayMoney', width: 130, renderer:function(val,item,rowIndex){return '￥'+val;}},
            {title:'积分抵扣金额', name:'onLinePayScoreMoney', width: 130, renderer:function(val,item,rowIndex){return '￥'+val;}},
            {title:'货到付款金额', name:'offLinePayMoney', width: 130, renderer:function(val,item,rowIndex){return '￥'+val;}},
